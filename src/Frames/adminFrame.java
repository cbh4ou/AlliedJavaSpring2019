...
public class adminFrame extends javax.swing.JFrame implements Runnable{
    ...
    public static DefaultTableModel emp;
    ...
    private void initComponents() {
        ...
        refreshETable = new javax.swing.JButton();
        ...
        saveEmp.setBackground(new java.awt.Color(71, 177, 175));
        saveEmp.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        saveEmp.setForeground(new java.awt.Color(255, 255, 255));
        saveEmp.setText("Save");
        saveEmp.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        saveEmp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saveEmpActionPerformed(evt);
            }
        });
        tranPanel2.add(saveEmp);
        saveEmp.setBounds(300, 110, 140, 50);

        refreshETable.setBackground(new java.awt.Color(71, 177, 175));
        refreshETable.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        refreshETable.setForeground(new java.awt.Color(255, 255, 255));
        refreshETable.setText("Refresh");
        refreshETable.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        refreshETable.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                refreshETableActionPerformed(evt);
            }
        });
        tranPanel2.add(refreshETable);
        refreshETable.setBounds(600, 110, 140, 50);
        ...
        empTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Employee ID", "First Name", "Last Name", "Phone", "Email", "Schedule"
            }
        ) {
        ...
        jScrollPane5.setBounds(3, 250, 1080, 430);
        ...
        searchButton2.setBackground(new java.awt.Color(71, 177, 175));
        searchButton2.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        searchButton2.setForeground(new java.awt.Color(255, 255, 255));
        searchButton2.setText("Refresh");
        ...
        tranPanel4.add(searchButton2);
        searchButton2.setBounds(920, 20, 140, 50);
 ...
 Datasource employee = new Datasource();
    ...
    private void refreshETableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshETableActionPerformed
      ...
      if(!employee.open()) {
       ...
       employee.close();
    }//GEN-LAST:event_refreshETableActionPerformed
    ...
    private javax.swing.JButton refreshETable;
    ...
    private void setPeople(DefaultTableModel emp1) {
        Datasource employee = new Datasource();
        if(!employee.open()) {
            System.out.println("Can't open datasource");
            return;
        ...
        for (int i = 0; i < emp1.getRowCount(); i++) {
            if (emp1.getValueAt(i, 0) == "" || emp1.getValueAt(i, 1) == null) {
                JOptionPane.showMessageDialog(null, "Database Error. Find Administrator");
            }
             
                employee.updateETable( Integer.parseInt( emp1.getValueAt(i, 0).toString() ), (String) emp1.getValueAt(i, 1),(String) emp1.getValueAt(i, 2),(String) emp1.getValueAt(i, 3)
                        ,(String) emp1.getValueAt(i, 4), (String) emp1.getValueAt(i, 5));
           
        }
           }catch(NumberFormatException e){
               System.out.println(e.getMessage() + "number format");
           }
